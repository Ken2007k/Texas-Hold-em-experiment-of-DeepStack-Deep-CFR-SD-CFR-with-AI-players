...
from DeepCFR.EvalAgentBasicCFR import EvalAgentBasicCFR
from DeepCFR.EvalAgentDeepStack import EvalAgentDeepStack
...
if __name__ == '__main__':
    ...
    ctrl = Driver(t_prof=TrainingProfile(name="EXPERIMENT_SD-CFR_vs_Deep-CFR_FHP",
                                         ...
                                         n_seats=9,
                                         # used algorithms,including three deep algos and six CFR players
                                         eval_modes_of_algo=(
                                             EvalAgentDeepCFR.EVAL_MODE_AVRG_NET, EvalAgentDeepCFR.EVAL_MODE_SINGLE,EvalAgentDeepStack.DeepStack,EvalAgentBasicCFR.RANDOM,EvalAgentBasicCFR.RANDOM,EvalAgentBasicCFR.RANDOM,EvalAgentBasicCFR.RANDOM,EvalAgentBasicCFR.RANDOM,EvalAgentBasicCFR.RANDOM,
                                         ),
    ...
    ctrl = Driver(t_prof=TrainingProfile(name="EXPERIMENT_SD-CFR_vs_Deep-CFR_FHP",
                                         ...
                                         eval_modes_of_algo=(
                                             ...
                                             EvalAgentDeepStack.DeepStack, EvalAgentBasicCFR.CFR,
                                             EvalAgentBasicCFR.CFR, EvalAgentBasicCFR.CFR,
                                             EvalAgentBasicCFR.CFR, EvalAgentBasicCFR.CFR,
                                             EvalAgentBasicCFR.CFR,
                                         ),
    ...
    ctrl = Driver(t_prof=TrainingProfile(name="EXPERIMENT_SD-CFR_vs_Deep-CFR_FHP",
                                         ...
                                         eval_modes_of_algo=(
                                             EvalAgentDeepCFR.EVAL_MODE_AVRG_NET, EvalAgentDeepCFR.EVAL_MODE_SINGLE,
                                             EvalAgentDeepStack.DeepStack, EvalAgentBasicCFR.CFR_PLUS,
                                             EvalAgentBasicCFR.CFR_PLUS, EvalAgentBasicCFR.CFR_PLUS,
                                             EvalAgentBasicCFR.CFR_PLUS, EvalAgentBasicCFR.CFR_PLUS,
                                             EvalAgentBasicCFR.CFR_PLUS,
                                         ),
